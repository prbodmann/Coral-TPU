...
train_dataset = prepare_dataset(ds['train'], is_training=True,batch_size_=batch_size)
val_dataset = prepare_dataset(ds['validation'], is_training=False,batch_size_=batch_size)
