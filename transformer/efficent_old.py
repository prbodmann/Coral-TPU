...
model = EfficientFormer(num_classes=5)

train_dataset1, val_dataset1 = tfds.load(
...
if os.path.isdir("efficent"):
    ...
    converter_quant = tf.lite.TFLiteConverter.from_saved_model("efficent")
